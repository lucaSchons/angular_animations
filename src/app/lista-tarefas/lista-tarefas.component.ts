...
import { clickButtonStateTrigger, highlightedStateTrigger, shownStateTrigger } from '../animations';

@Component({
  selector: 'app-lista-tarefas',
  templateUrl: './lista-tarefas.component.html',
  styleUrls: ['./lista-tarefas.component.css'],
  animations: [highlightedStateTrigger, shownStateTrigger, clickButtonStateTrigger]
})
